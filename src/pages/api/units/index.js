...
export async function POST({ request }) {
  ...
  const [row] = await sql`
    INSERT INTO real_estate_units (property_name, property_type, dong, ho, unit_type, unit_sqm, unit_supply_sqm, usage_type, address, address_detail)
    VALUES (${property_name}, ${property_type}, ${dong || null}, ${ho || null}, ${unit_type || null}, ${unit_sqm || null}, ${unit_supply_sqm || null}, ${usage_type || null}, ${address || null}, ${address_detail || null})
    RETURNING *
  `;
